...
<div class="card-header bg-primary text-white text-center">
        ...
        <div class="card shadow">
            <div class="card-body">
                <canvas id="kategoriHarcamaGrafik"></canvas>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const tutarlar = <?php echo json_encode($tutarlar); ?>;

        // Chart.js ile kategorilere göre toplam harcamaları gösteren grafik
        const ctx = document.getElementById('kategoriHarcamaGrafik').getContext('2d');
        new Chart(ctx, {
            type: 'bar', // Bar grafiği
            data: {
                labels: kategoriler, // X ekseni kategoriler
                datasets: [{
                    label: 'Toplam Harcama (₺)',
                    data: tutarlar, // Y ekseni harcamalar
                    backgroundColor: [
                        '#FF5733', '#33FFBD', '#FFC300', '#DAF7A6', '#C70039',
                        '#900C3F', '#581845', '#1D8348', '#117A65', '#2874A6'
                    ],
                    borderColor: '#333',
                    borderWidth: 1,
                }]
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(tooltipItem) {
                                return tooltipItem.raw.toLocaleString('tr-TR', {style: 'currency', currency: 'TRY'});
                            }
                        }
                    }
                },
